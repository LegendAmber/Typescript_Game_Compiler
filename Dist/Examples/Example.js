...
let newWorld = new World("Example world", 0, { type: "clear" }, [new CreateChunk(1, { type: TerrainTypes.TERRAIN_TYPE_ANTI_GRAVITY }, { type: TerrainTypes.TERRAIN_TYPE_DEFAULT_UNDERGROUND })], [], World.generateSeed(), 270, []);
